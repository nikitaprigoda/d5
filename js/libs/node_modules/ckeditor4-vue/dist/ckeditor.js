 ...
 */
! function(t, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports.CKEditor = n() : t.CKEditor = n()
}(window, (function() {
    return function(t) {
        var n = {};
        ...
        ! function(t, n) {
            ...
            V && (L = function(t) {
                ...
                fetch: function(t) {
                    return T(L, B.apply(f, arguments))
                }
            }))), u({
                global: !0,
                wrap: !0,
            ...
            (t.exports = function(t, n, e, s, l) {
                var p, d, v, h, y, m, g, x = c(n, e, s ? 2 : 1);
                if (l) p = t;
                else {
                ...
                for (m = p.next; !(g = m.call(p)).done;)
                    if ("object" == typeof(y = a(p, x, g.value, s)) && y && y instanceof f) return y;
                return new f(!1)
            }).stop = function(t) {
                return new f(!0, t)
            }
        ...
        var r = e(0),
            o = {
                ...
                props: {
                    ...
                    editorUrl: {
                        type: String,
                        default: "https://cdn.ckeditor.com/4.16.0/standard-all/ckeditor.js"
                    },
                    config: {
                        type: Object,
                        default: function(){}
                ...
                mounted:function() {
                    ...
                    Object(r.getEditorNamespace)(this.editorUrl, (function(t) {
                        self.$emit("namespaceloaded", t)
                    })).then((function() {
                        if (self.$_destroyed) return;
                        const t = self.config || {};
                        null !== self.readOnly && (t.readOnly = self.readOnly);
                        const n = "inline" === self.type ? "inline" : "replace",
                            e = self.$el.firstElementChild,
                            r = self.instance = CKEDITOR[n](e, t);
                        r.on("instanceReady", (function() {
                            const t = self.value;
                            r.fire("lockSnapshot"), r.setData(t, {
                                callback: function() {
                                    self.$_setUpEditorEvents();
                                    const n = r.getData();
                                    t !== n ? (self.$once("input", (function(){
                                        self.$emit("ready", r)
                                    })), self.$emit("input", n)) : self.$emit("ready", r), r.fire("unlockSnapshot")
                                }
                            })
                        }))
                    }))
                    ...
                    $_setUpEditorEvents:function() {
                        ...
                        const t = self.instance,
                            n = Object(r.debounce)((function(n) {
                                const e = t.getData();
                                self.value !== e && self.$emit("input", e, n, t)
                            }), self.throttle);
